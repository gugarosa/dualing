...
class OnContrastiveSiamese(Siamese):
    """An OnContrastiveSiamese class is responsible for implementing the
    contrastive version of Siamese Neural Networks with on-demand pair feeding.
    ...
    def __init__(self, base, distance='euclidean', margin=1.0, name=''):
        ...
        logger.info('Overriding class: Siamese -> OnContrastiveSiamese.')

        # Overrides its parent class with any custom arguments if needed
        super(OnContrastiveSiamese, self).__init__(base, name=name)
